...
function initializeBots(player) {
    ...
    for (let i = 0; i < numBots; i++) {
        bots.push({
            x: player.x + (Math.random() * 500 + 300),  // Start ahead of the player
            ...
            resetPosition() {
                // Reset to a position ahead of the player, near the middle of the screen
                this.x = player.x + (Math.random() * 500 + 300);
